...
export META_FILE="/mnt/nfs/file_server/public/wangrui/sd_finetune_lion400/deepfashion/df_sub1_cache.json"
export OUT_DIR="/mnt/nfs/file_server/public/wangrui/sd_finetune_lion400/sd_xl_test/deepfashion_v01"
...
OMP_NUM_THREADS=6 CUDA_VISIBLE_DEVICES=1,2 accelerate launch sdxl_train_with_text_cache.py --pretrained_model_name_or_path=$MODEL_DIR \
                                                --in_json $META_FILE \
                                                --optimizer_type="Adafactor" --optimizer_args="scale_parameter=False relative_step=False warmup_init=False" \
                                                --lr_scheduler="constant_with_warmup" --lr_warmup_steps=100 --learning_rate=1e-7 --train_batch_size=2 \
