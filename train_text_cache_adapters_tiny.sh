...
export META_FILE="/mnt/nfs/file_server/public/wangrui/sd_finetune_lion400/sd_xl_test/kohya_ss/finetuen_laion_3m/kohya_demo_cache.json"
export OUT_DIR="/mnt/nfs/file_server/public/wangrui/sd_finetune_lion400/sd_xl_test/sdxladapter_laion_12m_1024_v0.6_tiny"
...
CUDA_VISIBLE_DEVICES=4,5,6,7 accelerate launch --main_process_port 29590 sdxl_train_fulladapter_with_text_cache.py --pretrained_model_name_or_path=$MODEL_DIR \
                                                --in_json $META_FILE \
                                                --learning_rate=1e-5 --train_batch_size=4 \
